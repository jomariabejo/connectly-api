...
@Configuration
@EnableWebSecurity
// Without @EnableMethodSecurity the @PreAuthorize guards on /users/admin/** are never evaluated —
// those routes are outside every requestMatchers rule, so any authenticated user could call them.
